...
public class AccountControllerTests {
	...
	public void testHandleDetailsRequest() {
		...
		Account accountDetails = controller.accountDetails(expectedAccountId);
		...
		assertEquals(expectedAccountId, (long) accountDetails.getEntityId());
		// - The account number matches "expectedAccountNumber" defined above
		assertEquals(expectedAccountNumber, accountDetails.getNumber());
	}
